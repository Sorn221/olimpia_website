            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-10 mx-auto col-12">
                    <div class="hero-text mt-5 text-center">
                        ...
                        <a href="#feature" class="btn custom-btn mt-3" data-aos="fade-up" data-aos-delay="600">Старт</a>
                ...
                <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        ...
                        <div class="class-info">
                            ...
                            <p class="mt-3">Групповые занятия направленные на интенсивную работу и сброс веса (цена за
                                одну
                                тренировку)</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ml-auto col-lg-5 col-md-6 col-12">
                    <h2 class="mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">Напиши нам если остались вопросы</h2>
                    ...
                    <form action="#" method="post" class="contact-form webform" data-aos="fade-up" data-aos-delay="400"
                        ...
                        <textarea class="form-control" rows="5" name="cf-message" placeholder="Сообщение"></textarea>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="membership-form webform" role="form">
                        ...
                        <input type="email" class="form-control" name="cf-email" placeholder="timofeyFomin@gmail.com">

                        <input type="tel" class="form-control" name="cf-phone" placeholder="+7(999)999-99-99"
                            pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>

                        <textarea class="form-control" rows="3" name="cf-message" placeholder="Комментарий"></textarea>

                        <button type="submit" class="form-control" id="submit-button" name="submit">Отправить</button>
